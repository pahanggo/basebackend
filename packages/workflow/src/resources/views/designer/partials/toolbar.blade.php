...
<p class="small text-muted mb-2 version" x-show="versionCaption.hasVersion">
    <template x-if="versionCaption.number">
        <span>Editing version <span x-text="versionCaption.number"></span> — published<span x-show="versionCaption.isLive"> (currently live)</span></span>
    </template>
    <template x-if="! versionCaption.number">
        <span>Editing draft — not yet published</span>
    </template>
</p>
