@php
	...
	$field['wrapper']['class'] = $field['wrapper']['class'] ?? "form-group col-sm-6";

	if(isset($field['wrapper']) && isset($field['wrapper']['col'])) {
		$field['wrapper']['class'] = "form-group col-sm-" . $field['wrapper']['col'];
	}
