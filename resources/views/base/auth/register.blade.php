        ...
        <div class="col-12 col-md-8">
            <div class="card-group">
                ...
                <div class="card bg-gray-200">
                    <div class="card-body">
                        <p>
                            Or register via social accounts:
                        </p>
                        @if(config('auth.socialite.providers.google'))
                            <a href="{{route('socialite.google')}}" class="btn btn-primary btn-block">
                                <i class="la la-google-plus"></i>
                                Register With Google
                            </a>
                        @endif
                        @if(config('auth.socialite.providers.github'))
                            <a href="{{route('socialite.github')}}" class="btn btn-primary btn-block">
